                        ...
                        <a href="#subPages" data-toggle="collapse" class="collapsed">
                            ...
                            <div id="subPages" class="collapse">
                                <ul class="nav">
                                    ...
                                    <li class="active"><a href="<?php echo base_url('vetclinic/salesreport'); ?>" class=""><i class="now-ui-icons files_paper"></i>Sales Report</a></li>
                                </ul>
                            </div>
                        </li>
                    </li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="card-title">Sales Report Generator</h2>
                            </div>
                            <div class="card-body">
<br/><br/><br/>
